...
{% set _ = ref('clients_stg_update') %}
{% set _ = ref('clients_stg_exp') %}
{% set _ = ref('clients_stg_new') %}
{% set _ = ref('clients_stg') %}
...
FROM {{ ref("clients_stg_update") }} stg
